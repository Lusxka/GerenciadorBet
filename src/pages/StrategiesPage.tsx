        ...
        <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
          ...
          <input
            ...
            className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg 
                     ...
                     bg-white dark:bg-gray-700 text-gray-900 dark:text-white w-full sm:w-32 text-sm"
            min="100"
            step="100"
          />
            ...
            <tbody>
              {strategies.map((strategy) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 text-success-600 dark:text-success-400 font-medium text-sm">
                    +{strategy.winTarget}%
                  </td>
                  <td className="py-3 px-4 text-error-600 dark:text-error-400 font-medium text-sm">
                    -{strategy.lossLimit}%
                  </td>
                  <td className="py-3 px-4">
